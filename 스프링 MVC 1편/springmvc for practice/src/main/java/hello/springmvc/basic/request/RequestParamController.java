...
public class RequestParamController {
    ...
    /**
     * @RequestParam 사용
     * HTTP 파라미터 이름이 변수 이름과 같으면 @RequestParam(name="xx") 생략 가는ㅇ
     */
    @ResponseBody
     ...
     *
     * 주의!
     * /request-param-required?username= -> 빈 문자로 예외 X
     *
     * 주의!
     * /request-param-required
     * int age -> null을 int에 입력하는 것은 불가능
     * => 따라서 Integer 변경 or defaultValue 사용
     *
     * int age 사용 시
    ...
    /**
     * @ModelAtribute 사용
     * 참고: model.addAttribute(helloData) 코드도 함께 자동 제공
     *      뒤에 model 설명 시 자세히 설명
     */
    @ResponseBody
